  ...
  competencies: [
    {
      ...
      name: "課題解決",
      score: 4,
      bars_text: "データや事実から課題を特定し、複数案を比較して解決した",
      evidence_quote: "利用データを分析して、月次の活用会を自分で企画して実施しました",
      confidence: "high",
    },
    {
      ...
      name: "実行・完遂",
      score: 4,
      bars_text: "関係者を巻き込んで障害を取り除き、目標を達成した",
      evidence_quote: "CSと連携した導入設計で、担当顧客の解約率も半分にできました",
      confidence: "high",
    },
    {
    ...
    },
    {
      ...
      name: "学習・適応",
      score: 4,
      bars_text: "学んだことを仕組み・ノウハウ化し、他者にも展開した",
      evidence_quote: "断られた理由を全部記録して翌年の提案に活かしています",
      confidence: "med",
    },
    {
      ...
      name: "主体性",
      score: 4,
      bars_text: "誰も担っていない課題を自ら定義し、周囲を動かして解決した",
      evidence_quote: "月次の活用会を自分で企画して実施しました",
      confidence: "high",
    },
  ],
  values: ["顧客起点", "誠実さ", "継続"],
